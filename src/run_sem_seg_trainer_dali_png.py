...
from trainer.train_sem_seg_dali_png import train_sem_seg_pipeline
...
def parse_arguments() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        default=4,
        type=int,
        help="num threads to be used in the dataloaders (choose num_workers <= batch_size, physical CPU cores)",
    )
    parser.add_argument(
        "--num-in-channels",
        default=1,
    ...
    parser.add_argument(
        "--out-log-file",
        default="hrsid_sem_seg_trainer_dali_png.log",
        type=str,
