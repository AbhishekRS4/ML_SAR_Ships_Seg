...
from utils.move_data_for_training import move_bg_images_n_labels
...
def parse_args() -> argparse.Namespace:
    ...
    arg_parser.add_argument(
        ...
        default=None,
        type=str,
        help="full path to the directory where pure labels are present",
    )
    arg_parser.add_argument(
        "--dir-train-images",
        default=None,
...
def main() -> None:
    ...
    move_bg_images_n_labels(
        ARGS.dir_pure_bg_images,
        ARGS.dir_pure_bg_labels,
